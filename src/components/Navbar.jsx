  ...
  return (
    <nav className="pb-[108px] pt-[40px] md:pt-[25px] lg:pt-[35px]">
      <div className="hidden md:flex mb-[20px] justify-between">
        ...
        <div className="flex justify-between w-[162px]">
      ...
      <div className="relative flex justify-between items-center bg-white rounded p-1">
        ...
        {mobileDrawerOpen && (
          <div className="absolute top-10 md:top-12 left-0 z-20 bg-white pl-6 pr-8 py-4 md:pl-12 md:pr-14 md:py-10 rounded-xl flex flex-col lg:hidden">
        ...
        <div
          ...
          className="cursor-pointer absolute left-1/2 transform -translate-x-1/2 h-[60px] w-[100px] md:h-[90px] md:w-[200px] bg-white flex items-center justify-center rounded"
        >
